...
|vp8_intra4x4_predict_armv6| PROC
    ...
    movlt.n       r12, pc
    addlt.w       r12, #12
    addlt.w       r12, r12, r3, lsl #(2-1)
    movlt.n       pc, r12       ; position independent switch
...
b_rd_pred
    ldrb        r7, [r1]
    add        r1, r1, r2            ; l[0] = pp[3]
    ldr         lr, [r0]                ; Above = pp[8|7|6|5]
    ldrb        r8, [sp, #48]           ; tl   = pp[4]
    ldrb        r6, [r1]
    add        r1, r1, r2            ; l[1] = pp[2]
    ldrb        r5, [r1]
    add        r1, r1, r2            ; l[2] = pp[1]
    ldrb        r4, [r1]
    add        r1, r1, r2            ; l[3] = pp[0]
