...
|width_loop_1st_6|
    ...
    strh    lr, [r1]
    add    r1, r1, r12                   ; result is transposed and stored, which
...
|width_loop_2nd|
    ...
    add     r10, r10, #0x40
    strb    lr, [r1]
    add    r1, r1, r2                    ; the result is transposed back and stored
...
|height_loop_2nd_only_6|
    ...
    add     lr, lr, #0x40                   ; round_shift_and_clamp
    ldrbne  r8, [r0]
    addne  r0, r0, r2                    ; load data for next loop
    usat    lr, #8, lr, asr #7
    add     r10, r10, #0x40
    strb    lr, [r1]
    add    r1, r1, r12                   ; store the result for the column
    usat    r10, #8, r10, asr #7
