...
static INLINE int pthread_cond_init(pthread_cond_t *const condition,
                                    void* cond_attr) {
  (void)cond_attr;
  condition->waiting_sem_ = CreateSemaphoreEx(NULL, 0, MAX_DECODE_THREADS, NULL, 0, SEMAPHORE_ALL_ACCESS);
  condition->received_sem_ = CreateSemaphoreEx(NULL, 0, MAX_DECODE_THREADS, NULL, 0, SEMAPHORE_ALL_ACCESS);
  condition->signal_event_ = CreateEventEx(NULL, NULL, 0, EVENT_ALL_ACCESS);
